...
public class PlainTextReader implements TextReader {
    ...
    public PlainTextReader(Processor processor) {
    ...
    public void setFiles(String inputFileName, String outputFileName) throws IllegalArgumentException {
        ...
        if (!inputFileName.endsWith(".txt") || !outputFileName.endsWith(".txt")) {
            throw new IllegalArgumentException("Input and output file names must end with .txt.");
        }
