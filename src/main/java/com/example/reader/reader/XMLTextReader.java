...
public class XMLTextReader implements TextReader {
    ...
    public XMLTextReader(Processor processor) {
    ...
    public void setFiles(String inputFileName, String outputFileName) throws IllegalArgumentException {
        ...
        if (!inputFileName.endsWith(".xml") || !outputFileName.endsWith(".xml")) {
            throw new IllegalArgumentException("Input and output file names must end with .xml.");
        }
